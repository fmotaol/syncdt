...
BEGIN
    ...
    LOOP
        ...
        raise notice 'R%: Excluído(s) % registro(s) de %.% => %', rec.id, rows_affected, rec.derived_schema, rec.derived_table, rec.FILTER;
        ...
        raise notice 'R%: Reinserido % registro(s) de %.% => %', rec.id, rows_affected, rec.derived_schema, rec.derived_table, rec.FILTER;
